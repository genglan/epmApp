 ...
 *  @return
 */
function getAgentCode (success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"UserPlugin","getAgentCode",[]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"UserPlugin","getAgentCode","");
    }
}
 ...
 *  @return
 */
function changePassword (success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"FileOperationPlugin","changePassword",[]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"FileOperationPlugin","changePassword","");
    }
}
 ...
 *  @param  failed_callback     失败回调
 *
 *  @return 成功返回{"appId":""} 失败返回{@"message":@"查询结果为空"}
 */
function queryAppIDByAppName (key,success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"TableDataPlugin","queryAppIDByAppName",[key]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"TableDataPlugin","queryAppIDByAppName",key);
    }
}
/** ==================== 执行SQL update语句 ==================== */
/**
...
/** ==================== 执行多条SQL update语句 ==================== */
/**
 *  @brief  执行多条SQL update语句
 *
 *  @param  key                 [{"databaseName":"","sql":""},{"databaseName":"","sql":""}]
 *  @param  success_callback    成功回调
 *  @param  failed_callback"    失败回调
 *
 *  @return 全部成功返回1 其中任何一条失败返回0
 */
function executeUpdateUseSqls (key,success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"TableDataPlugin","executeUpdateUseSqls",[key]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"TableDataPlugin","executeUpdateUseSqls",key);
    }
}
/** ==================== 判断某个路径是否存在文件 ==================== */
/**
 ...
 *  @return 存在返回1 不存在返回0
 */
function fileExistsAtPath (key,success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"FileOperationPlugin","fileExistsAtPath",[key]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"FileOperationPlugin","fileExistsAtPath",key);
    }
}
 ...
 *  @return 无返回值
 */
function closeApplicationCenter (success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"ApplicationCenterPlugin","closeApplicationCenter",[]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"ApplicationCenterPlugin","closeApplicationCenter","");
    }
}
/** ==================== 微信分享网页到朋友圈 ==================== */
/**
 ...
 *  @return 字典的集合s
 */
function WebPageShareToWXFriend (key,success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"WXEntryPlugin","WebPageShareToWXFriend",[key]);
    }
    // Android
    else if(brows().android) {
        alert("分享");
        return  cordova.exec(success_callback,failed_callback,"WXEntryPlugin","WebPageShareToWXFriend",key);
    }
}
/** ==================== 微信分享网页到个人 ==================== */
/**
 ...
 *  @return 字典的集合s
 */
function WebPageShareToWXPerson (key,success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"WXEntryPlugin","WebPageShareToWXPerson",[key]);
    }
    // Android
    else if(brows().android) {
        alert("分享");
        return  cordova.exec(success_callback,failed_callback,"WXEntryPlugin","WebPageShareToWXPerson",key);
    }
}
/** ==================== 保存图片到本地 ==================== */
/**
 *  @brief  {"saveImagePath":"","downLoadPath":""}
 *
 *  @param  success_callback    成功回调
 *  @param  failed_callback"    失败回调
 *
 *  @return 字典的集合s
 */
function saveImageToNative (key,success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"SaveImageToNativePlugin","saveImageToNative",[key]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"SaveImageToNativePlugin","saveImageToNative",key);
    }
}
/** ==================== 保存多张图片到本地 ==================== */
/**
 *  @brief  保存多张图片到本地
 *
 *  @param  key      {data:["",""],savePath:""}
 *  @param  success_callback    成功回调
 *  @param  failed_callback"    失败回调
 *
 *  @return 集合s
 */
function downLoadImage (key,success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"SaveImageToNativePlugin","downLoadImage",[key]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"SaveImageToNativePlugin","downLoadImage",key);
    }
}
/** ==================== 根据sql查询表单数据 ==================== */
/**
 ...
 *  @return 成功返回1  失败返回0
 */
function jsonToPdf(key, success_callback, failed_callback){
    //ios
    if(brows().iphone) {
        
        cordova.exec(success_callback, failed_callback, "TransformPDFPlugin", "jsonToPDF", [key]);
    }
    // Android
    else if(brows().android) {
        return cordova.exec(success_callback, failed_callback, "TransformPDFPlugin", "josnToPDF", key);
    }
}
/** ==================== Http请求  Get方式 ==================== */
/**
 ...
 *  @return 删除数据库成功返回1  删除数据库失败返回0
 */
function queryAppSaveData(success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"TableDataPlugin","queryAppSaveData",[]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"TableDataPlugin","queryAppSaveData","");
    }
}
/** ==================== 查询全部表单数据 ==================== */
/**
